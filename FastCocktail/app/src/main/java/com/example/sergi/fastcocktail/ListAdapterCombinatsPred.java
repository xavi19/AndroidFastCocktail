 ...
 */
public class ListAdapterCombinatsPred extends BaseAdapter {

    private LinkedList<Combinat> llista=new LinkedList<Combinat>();
    private int mCount;

    ListAdapterCombinatsPred(LinkedList<Combinat> llista) {
        mCount=llista.size();
       this.llista=llista;
    }
    ...
    public View getView(final int position, final View convertView,
        ...
        if (view == null) {
            view = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.fila_comb_pred, parent, false);
            //view.setBackgroundResource(R.drawable.sombra_articles);
            view.setMinimumHeight(50);
        }

        TextView textNom=(TextView)view.findViewById(R.id.combinat_pred_nom);
        TextView textPreu=(TextView)view.findViewById(R.id.combinat_pred_preu);
        TextView textId=(TextView)view.findViewById(R.id.combinat_pred_id);
